# -*- coding: utf-8 -*-
"""
Created on Sun Jan 19 15:53:07 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 19 15:07:52 2020
...
iteration = 100
n_ants =26
n_facility = 26         ####### 1 PLUS ACTUAL NO OF FACILITES
n_cust=25
e=0.5
alpha=2
break_limit=20
...
overall_minimum_dist_covered=10000
...
#                        print("unsatisfied cust =", unsatisfied_cust)
...
#                    elif distance_covered< maximum_distance and demand_satisfied==total_demand:
#                        print("aaaaaaaaaaaaaaaaaaaaaaaaaa")
#                        distance_covered=0
##                        route_name[u][i,j+1]=1
#                        for v in range(n_facility-1):
...
#    max_satisfied_cust = demand_satisfied_array[satisfied_demand_max_loc]         #finging min of dist_cost
    ...
    overall_distance_covered_list=[sum(x) for x in zip(*distance_covered_list)]
    ...
    if overall_demand_satisfied_array.size==0:
        ...
        max_satisfied_cust=0
    else:
    
#    satisfied_demand_max_loc = np.argmax(overall_demand_satisfied_array)
        maximum_demand_satisfd=max(overall_demand_satisfied_array)
        rough=np.where(overall_demand_satisfied_array == maximum_demand_satisfd)
        satisfied_demand_max_locationS=rough[0]
        zzz=[]
        for PP in satisfied_demand_max_locationS:
            zzz.append(overall_distance_covered_array[PP])
        xxx=np.array(zzz)
        minimum_distance=min(xxx)
        rough1=np.argmin(xxx)
        satisfied_demand_max_loc=satisfied_demand_max_locationS[int(rough1)]
...
#        print("max satisfied cust in iteration", ite, "=", max_satisfied_cust)
        min_travelled_dist= overall_distance_covered_array[satisfied_demand_max_loc]
#        print("min travelled dist in iteration", ite, "=", min_travelled_dist)
...
#        print("ooh yeeeeahh")
        ...
        overall_minimum_dist_covered=min_travelled_dist
        
        
        for A in range(len(overall_best_route)):
            overall_best_route[A]=route_name[A][satisfied_demand_max_loc]
#        print("overall best route in iteration", ite, "=", overall_best_route)

############INITIALISING MIN AND MAX PHEROMONE LEVEL                 

        maximum_pheromne=1/(e* overall_minimum_dist_covered)
        minimum_pheromne=maximum_pheromne/5
        
    if(( max_satisfied_cust == overall_max_satisfied_cust) and (overall_minimum_dist_covered>min_travelled_dist)):
#        print(" hurraayyy ")
        overall_minimum_dist_covered=min_travelled_dist
        overall_max_satisfied_cust=max_satisfied_cust
...
############INITIALISING MIN AND MAX PHEROMONE LEVEL                 
        ...
        maximum_pheromne=1/(e* overall_minimum_dist_covered)
        minimum_pheromne=maximum_pheromne/5
#    print("overall maximum satisfied cust in iteration", ite, "= ", overall_max_satisfied_cust )
#    print("overall min dist covered in iteration", ite, "= ", overall_minimum_dist_covered )    
#               
#    maximum_pheromne=1/(e* overall_minimum_dist_covered)
#    minimum_pheromne=maximum_pheromne/5     
#    best_route = route[satisfied_demand_max_loc,:]
###################################################################################3
########$$$$$$$$$$$$$$$$$$$$     CHECK PHEROMONE UPDATE    $$$$$$$$$$$$$$$$$$$$$$$
        ####### PHEROMNE UPDATE ON THE BASIS OF DISTANCE $$$$$$$$$$$$$$$$$$$
#####$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
######LOCAL PHEROMNE UPDATE    
    ...
    for c in range(len(overall_demand_satisfied_array)):
        for v in range(n_facility-1):
            dt = 1/overall_distance_covered_array[c]
...
print("total distance covered =",overall_minimum_dist_covered)
